        ...
        <div class="row m-0">
            <div class="col-lg-4 offset-lg-2">
                <div class="text-center pb-5">
                    <h1 class="login-title text-dark">Đăng ký</h1>
                    <p class="p-1 m-0 font-ubuntu text-black-50">Đăng ký</p>
                    <span class="font-ubuntu text-black-50">Sẵn Sáng <a href="login.php">Đăng nhập</a></span>
                </div>
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        ...
                        <small class="form-text text-black-50">Chọn ảnh đại diện</small>
                ...
                <div class="d-flex justify-content-center">
                    <form action="register.php" method="post" enctype="multipart/form-data" id="reg-form">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label for="agreement" class="form-check-label font-ubuntu text-black-50">Đồng ý </label>
                        </div>
